...
type Order struct {
	...
	Status        string                 `protobuf:"bytes,5,opt,name=status,proto3" json:"status,omitempty"` // "created", "paid", "shipped", "completed"
...
const file_internal_proto_order_proto_rawDesc = "" +
	"\n" +
	"\x1ainternal/proto/order.proto\x12\x05order\"\\\n" +
	"\tOrderItem\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x01R\x05price\"\xa5\x01\n" +
	"\x05Order\x12\x0e\n" +
	...
	"\x0eListUserOrders\x12\x18.order.ListOrdersRequest\x1a\x19.order.ListOrdersResponseB6Z4github.com/yourusername/order-service/internal/protob\x06proto3"
